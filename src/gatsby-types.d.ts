...
type PostQuery = { readonly markdownRemark: { readonly htmlAst: Record<string, unknown> | null, readonly frontmatter: { readonly title: string | null, readonly createDate: string | null, readonly updateDate: string | null } | null } | null };
